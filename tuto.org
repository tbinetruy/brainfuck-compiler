...
In order to install these packages, you'll need to setup Emacs' community repository, MELPA [4] https://melpa.org/, which you can learn how to on Emacs' wiki [5]. Installing ~paredit~ is then as simple as typing ~M-x package-install RET paredit RET~.
